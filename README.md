...
..1 R-Markdown file containing the proposal
..1 HTML-, Word-, and pdf-files knitted from the R-Markdown file
..1 bib-file containing the references from the proposal
..1 other documents or data used for this assignment (e.g. map of countries included in the dataset)
