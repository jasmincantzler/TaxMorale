...
dummy_df<-data.frame(data.numeric$Country, data.numeric$TrustPresident, data.numeric$CorruptionTax, data.numeric$CorruptionParliament, data.numeric$SelfEmployedTax, data.numeric$AvoidHowOften, data.numeric$Religion, data.numeric$Gender, data.numeric$LivingConditions, data.numeric$Age)
