...
#MODEL SPECIFICATION
# 1) Models with all three rounds including the following variables:
#   - trust in the government (president)
#   - level of corruption (president)
#   - country fixed effects
#   - year/"round" fixed effects
#   - living conditions
#   - age
#   - gender
#   - religious 
# create a sub-dataset:
data1 <- DropNA(data.factors, c("TaxMorale", "TrustPresident", "CorruptionPresident", "Country", "Year",
                                  "LivingConditions", "Age", "Gender", "Religion"))
# 27912 rows dropped from the data frame (that is 26.7% of all observations)
summary(data1)
summary(data1$Country) # 2 countries (Morocco, and Swaziland) droped from the dataset
