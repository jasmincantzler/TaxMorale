...
##Design
A regression analysis is used to investigate the determinants of tax morale in Africa, utilizing cross-sectional survey data from the Afrobarometer Survey [@Afro].Our conceptual framework is based on the determinants of tax morale in developed countries, whereby:
