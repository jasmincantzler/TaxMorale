...
**write a few paragraphs about Africa**
...
###Control Variables
We include **insert number** control variables in our model that provide information about gender, religion, country the respondent resides in, **include % of the distribution per variable***
